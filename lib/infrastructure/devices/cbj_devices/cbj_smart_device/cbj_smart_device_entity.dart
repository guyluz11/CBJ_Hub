...
// import 'package:cbj_hub/infrastructure/devices/cbj_devices/cbj_smart_device_api/cbj_smart_device_api_object.dart';
...
//
// class CbjDevicesV2Entity extends GenericBoilerDE {
//   CbjDevicesV2Entity({
...
//         ) {
//     switcherObject = CbjDevicesApiObject(
//       deviceType: CbjDevicesDevicesTypes.switcherV2Esp,
...
//   }
//
//   CbjDevicesMacAddress switcherMacAddress;
//
//   /// CbjDevices communication port
//   CbjDevicesPort? switcherPort;
//
//   DeviceLastKnownIp lastKnownIp;
//
//   /// CbjDevices package object require to close previews request before new one
//   CbjDevicesApiObject? switcherObject;
//
//   String? autoShutdown;
...
//           );
//         } else {
//           logger.e('actionToPreform is not set correctly on CbjDevices V2');
//         }
//       }
