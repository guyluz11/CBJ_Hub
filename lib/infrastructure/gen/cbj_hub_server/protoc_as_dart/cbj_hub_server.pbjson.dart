...
final $typed_data.Uint8List sendingTypeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List deviceStateGRPCDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List vendorsAndServicesDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List deviceTypesDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List deviceActionsDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List whenToExecuteDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List areaPurposesTypesDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List clientStatusRequestsDescriptor = $convert.base64Decode(
    'ChRDbGllbnRTdGF0dXNSZXF1ZXN0cxI1CgtzZW5kaW5nVHlwZRgpIAEoDjITLkNiakh1Yi5TZW5kaW5nVHlwZVILc2VuZGluZ1R5cGUSLAoRYWxsUmVtb3RlQ29tbWFuZHMYKiABKAlSEWFsbFJlbW90ZUNvbW1hbmRz');
...
final $typed_data.Uint8List requestsAndStatusFromHubDescriptor =
    $convert.base64Decode(
        'ChhSZXF1ZXN0c0FuZFN0YXR1c0Zyb21IdWISNQoLc2VuZGluZ1R5cGUYKyABKA4yEy5DYmpIdWIuU2VuZGluZ1R5cGVSC3NlbmRpbmdUeXBlEiwKEWFsbFJlbW90ZUNvbW1hbmRzGCwgASgJUhFhbGxSZW1vdGVDb21tYW5kcw==');
...
final $typed_data.Uint8List allRemoteCommandsDescriptor = $convert.base64Decode(
    'ChFBbGxSZW1vdGVDb21tYW5kcxJBCg9zbWFydERldmljZUluZm8YKCABKAsyFy5DYmpIdWIuU21hcnREZXZpY2VJbmZvUg9zbWFydERldmljZUluZm8=');
...
const FirstSetupMessage$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.CbjHub.FirebaseAccountInformation',
...
final $typed_data.Uint8List firstSetupMessageDescriptor = $convert.base64Decode(
    'ChFGaXJzdFNldHVwTWVzc2FnZRIvCghjb21wSW5mbxgmIAEoCzITLkNiakh1Yi5Db21wSHViSW5mb1IIY29tcEluZm8SYgoaZmlyZWJhc2VBY2NvdW50SW5mb3JtYXRpb24YJyABKAsyIi5DYmpIdWIuRmlyZWJhc2VBY2NvdW50SW5mb3JtYXRpb25SGmZpcmViYXNlQWNjb3VudEluZm9ybWF0aW9u');
...
final $typed_data.Uint8List compHubInfoDescriptor = $convert.base64Decode(
    'CgtDb21wSHViSW5mbxIrCgdjYmpJbmZvGC8gASgLMhEuQ2JqSHViLkNiakh1Yklub1IHY2JqSW5mbxIyCgljb21wU3BlY3MYFSABKAsyFC5DYmpIdWIuQ29tcEh1YlNwZWNzUgljb21wU3BlY3M=');
...
final $typed_data.Uint8List cbjHubInoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List compHubSpecsDescriptor = $convert.base64Decode(
    'CgxDb21wSHViU3BlY3MSFgoGY29tcElkGBYgASgJUgZjb21wSWQSGgoIY29tcFV1aWQYFyABKAlSCGNvbXBVdWlkEhYKBmNvbXBPcxgYIAEoCVIGY29tcE9zEhwKCWNvbXBNb2RlbBgZIAEoCVIJY29tcE1vZGVsEhoKCGNvbXBUeXBlGBogASgJUghjb21wVHlwZRIWCgZjb21wSXAYMiABKAlSBmNvbXBJcA==');
...
final $typed_data.Uint8List smartDeviceInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List mqttMassageDescriptor = $convert.base64Decode(
    'CgtNcXR0TWFzc2FnZRIcCgltcXR0VG9waWMYLCABKAlSCW1xdHRUb3BpYxIgCgttcXR0TWFzc2FnZRgtIAEoCVILbXF0dE1hc3NhZ2U=');
...
final $typed_data.Uint8List smartDeviceUpdateDetailsDescriptor =
    $convert.base64Decode(
        'ChhTbWFydERldmljZVVwZGF0ZURldGFpbHMSOQoLc21hcnREZXZpY2UYBiABKAsyFy5DYmpIdWIuU21hcnREZXZpY2VJbmZvUgtzbWFydERldmljZRIYCgduZXdOYW1lGAcgASgJUgduZXdOYW1l');
...
final $typed_data.Uint8List deviceTypesActionsDescriptor = $convert.base64Decode(
    '');
