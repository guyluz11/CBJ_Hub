...
final $typed_data.Uint8List cbjDeviceTypesDescriptor = $convert.base64Decode(
    'Cg5DYmpEZXZpY2VUeXBlcxIUChB0eXBlTm90U3VwcG9ydGVkEAASCQoFbGlnaHQQARIKCgZibGluZHMQAhIKCgZib2lsZXIQAxIKCgZidXR0b24QBBITCg9idXR0b25XaXRoTGlnaHQQBRIHCgNodWIQBxIMCghwaG9uZUFwcBAIEg8KC2NvbXB1dGVyQXBwEAkSDgoKYnJvd3NlckFwcBAKEhEKDXNtYXJ0Q29tcHV0ZXIQCw==');
...
final $typed_data.Uint8List cbjDeviceActionsDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List cbjWhenToExecuteDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List cbjDeviceStateGRPCDescriptor = $convert.base64Decode(
    'ChJDYmpEZXZpY2VTdGF0ZUdSUEMSFQoRc3RhdGVOb3RTdXBwb3J0ZWQQABIYChRjYW5jZWxTdGF0ZUluUHJvY2VzcxABEgcKA2FjaxACEhIKDm5ld1N0YXRlRmFpbGVkEAMSEQoNd2FpdGluZ0luQ29tcBAE');
...
final $typed_data.Uint8List cbjClientStatusRequestsDescriptor =
    $convert.base64Decode(
        'ChdDYmpDbGllbnRTdGF0dXNSZXF1ZXN0cxJdChFhbGxSZW1vdGVDb21tYW5kcxgpIAEoCzIvLkNialNtYXJ0RGV2aWNlQ29ubmVjdGlvbnMuQ2JqQWxsUmVtb3RlQ29tbWFuZHNSEWFsbFJlbW90ZUNvbW1hbmRz');
...
final $typed_data.Uint8List cbjRequestsAndStatusFromHubDescriptor =
    $convert.base64Decode(
        'ChtDYmpSZXF1ZXN0c0FuZFN0YXR1c0Zyb21IdWISXQoRYWxsUmVtb3RlQ29tbWFuZHMYKiABKAsyLy5DYmpTbWFydERldmljZUNvbm5lY3Rpb25zLkNiakFsbFJlbW90ZUNvbW1hbmRzUhFhbGxSZW1vdGVDb21tYW5kcw==');
...
final $typed_data.Uint8List cbjAllRemoteCommandsDescriptor = $convert.base64Decode(
    'ChRDYmpBbGxSZW1vdGVDb21tYW5kcxJXCg9zbWFydERldmljZUluZm8YKCABKAsyLS5DYmpTbWFydERldmljZUNvbm5lY3Rpb25zLkNialNtYXJ0RGV2aWNlSW5mb1IPc21hcnREZXZpY2VJbmZv');
...
final $typed_data.Uint8List cbjFirstSetupMessageDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List cbjCompSmartDeviceInfoDescriptor =
    $convert.base64Decode(
        'ChZDYmpDb21wU21hcnREZXZpY2VJbmZvEkUKCWNvbXBTcGVjcxgVIAEoCzInLkNialNtYXJ0RGV2aWNlQ29ubmVjdGlvbnMuQ2JqQ29tcFNwZWNzUgljb21wU3BlY3MSXQoSc21hcnREZXZpY2VzSW5Db21wGBwgAygLMi0uQ2JqU21hcnREZXZpY2VDb25uZWN0aW9ucy5DYmpTbWFydERldmljZUluZm9SEnNtYXJ0RGV2aWNlc0luQ29tcA==');
...
final $typed_data.Uint8List cbjCompSpecsDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List cbjMicrocontrollerSpecsDescriptor =
    $convert.base64Decode(
        'ChdDYmpNaWNyb2NvbnRyb2xsZXJTcGVjcxIyChRtaWNyb2NvbnRyb2xsZXJNb2RlbBgfIAEoCVIUbWljcm9jb250cm9sbGVyTW9kZWwSMAoTbWljcm9jb250cm9sbGVyVHlwZRggIAEoCVITbWljcm9jb250cm9sbGVyVHlwZRIoCg9zb2Z0d2FyZVZlcnNpb24YISABKAlSD3NvZnR3YXJlVmVyc2lvbg==');
...
final $typed_data.Uint8List cbjSmartDeviceInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List cbjSmartDeviceUpdateDetailsDescriptor =
    $convert.base64Decode(
        'ChtDYmpTbWFydERldmljZVVwZGF0ZURldGFpbHMSTwoLc21hcnREZXZpY2UYBiABKAsyLS5DYmpTbWFydERldmljZUNvbm5lY3Rpb25zLkNialNtYXJ0RGV2aWNlSW5mb1ILc21hcnREZXZpY2USGAoHbmV3TmFtZRgHIAEoCVIHbmV3TmFtZQ==');
...
final $typed_data.Uint8List cbjFirebaseAccountInformationDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List cbjDeviceTypesActionsDescriptor = $convert.base64Decode(
    '');
